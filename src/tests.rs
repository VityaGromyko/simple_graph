...
mod tests {
    ...
    fn test_bfs() {
        ...
        graph.add_edge("B", "D", "edge").unwrap();
        graph.add_edge("C", "B", "edge").unwrap();
        graph.add_edge("C", "D", "edge").unwrap();
        graph.add_edge("C", "E", "edge").unwrap();
        graph.add_edge("D", "B", "edge").unwrap();
        graph.add_edge("D", "C", "edge").unwrap();
